...
const stETH = new index_js_3.Token({
    chainId: 1,
...
const sBTC = new index_js_3.Token({
    chainId: 1,
...
exports.sETH = new index_js_3.Token({
    chainId: 1,
...
const rETH = new index_js_3.Token({
    chainId: 1,
...
const ankrETH = new index_js_3.Token({
    chainId: 1,
...
const frxETH = new index_js_3.Token({
    chainId: 1,
...
const sEUR = new index_js_3.Token({
    chainId: 1,
...
const EURS = new index_js_3.Token({
    chainId: 1,
...
const aDAI = new index_js_3.Token({
    chainId: 1,
...
const aSUSD = new index_js_3.Token({
    chainId: 1,
...
const cUSDC = new index_js_3.Token({
    chainId: 1,
...
const cDAI = new index_js_3.Token({
    chainId: 1,
...
const sLINK = new index_js_3.Token({
    chainId: 1,
...
const sUSD = new index_js_3.Token({
    chainId: 1,
...
const HBTC = new index_js_3.Token({
    chainId: 1,
...
const ETH = index_js_3.Native.onChain(index_js_1.ChainId.ETHEREUM);
exports.CURVE_NON_FACTORY_POOLS = {
    [index_js_1.ChainId.ETHEREUM]: [
        [
            ...
            [index_js_2.DAI[index_js_1.ChainId.ETHEREUM], index_js_2.USDC[index_js_1.ChainId.ETHEREUM], index_js_2.USDT[index_js_1.ChainId.ETHEREUM]],
        ],
        [
            // susd
        ...
        [
            ...
            CurvePoolType.Legacy,
            [index_js_2.FRAX[index_js_1.ChainId.ETHEREUM], index_js_2.USDC[index_js_1.ChainId.ETHEREUM]],
        ],
        [
            '0xf253f83aca21aabd2a20553ae0bf7f65c755a07f',
            CurvePoolType.Legacy,
            [index_js_2.WBTC[index_js_1.ChainId.ETHEREUM], sBTC],
        ],
        [
        ...
        [
            ...
            CurvePoolType.Legacy,
            [index_js_2.LINK[index_js_1.ChainId.ETHEREUM], sLINK],
        ],
        [
            '0x4ca9b3063ec5866a4b82e437059d2c43d1be596f',
            CurvePoolType.LegacyV3,
            [HBTC, index_js_2.WBTC[index_js_1.ChainId.ETHEREUM]],
        ],
        [
            '0x93054188d876f558f4a66b2ef1d97d16edf0895b',
            CurvePoolType.LegacyV2,
            [index_js_2.renBTC[index_js_1.ChainId.ETHEREUM], index_js_2.WBTC[index_js_1.ChainId.ETHEREUM]],
        ],
...
class CurveProvider extends LiquidityProvider_js_1.LiquidityProvider {
    foundPools = [];
    getType() {
    ...
    async getPoolsForTokens(t0, t1, excludePools) {
        const pools = new Map();
        let currencyCombinations = (0, get_currency_combinations_js_1.getCurrencyCombinations)(this.chainId, t0, t1);
    ...
    async getPoolRatio(pools) {
        if (this.chainId === index_js_1.ChainId.ETHEREUM) {
    ...
    async getCurvePoolCodes(pools) {
        ...
        const poolCodes = poolArray.flatMap(([poolAddress, [, tokens]], i) => {
            ...
            if (_fee === undefined ||
                ...
                _ratio === undefined)
                return [];
            const poolTines = (0, index_js_4.createCurvePoolsForMultipool)(poolAddress, tokens, Number(_fee) / 1e10, Number(_A), [_balance0, _balance1, _balance2, _balance3].slice(0, tokens.length), _ratio);
            return poolTines.map((p) => new CurvePool_js_1.CurvePoolCode(p, this.getType(), this.getPoolProviderName()));
        });
