...
function maxLiquidityForAmount0Imprecise(sqrtRatioAX96, sqrtRatioBX96, amount0) {
    ...
    const intermediate = (sqrtRatioAX96 * sqrtRatioBX96) / internalConstants_js_1.Q96;
    return ((BigInt(amount0.toString()) * intermediate) /
...
function maxLiquidityForAmount0Precise(sqrtRatioAX96, sqrtRatioBX96, amount0) {
    ...
    const denominator = internalConstants_js_1.Q96 * (sqrtRatioBX96 - sqrtRatioAX96);
...
function maxLiquidityForAmount1(sqrtRatioAX96, sqrtRatioBX96, amount1) {
    ...
    return (BigInt(amount1.toString()) * internalConstants_js_1.Q96) / (sqrtRatioBX96 - sqrtRatioAX96);
}
/**
