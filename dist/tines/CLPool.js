...
exports.CLRPool = exports.CL_MAX_TICK = exports.CL_MIN_TICK = void 0;
const RPool_js_1 = require("./RPool.js");
exports.CL_MIN_TICK = -887272;
exports.CL_MAX_TICK = -exports.CL_MIN_TICK - 1;
const ZERO = 0n;
...
const two96 = 2 ** 96;
class CLRPool extends RPool_js_1.RPool {
    tickSpacing;
    liquidity;
    sqrtPriceX96;
    nearestTick;
    ...
    constructor(address, token0, token1, fee, tickSpacing, reserve0, reserve1, liquidity, sqrtPriceX96, nearestTick, ticks) {
        ...
        if (this.ticks.length === 0) {
            this.ticks.push({ index: exports.CL_MIN_TICK, DLiquidity: ZERO });
            this.ticks.push({ index: exports.CL_MAX_TICK, DLiquidity: ZERO });
        }
        if (this.ticks[0].index > exports.CL_MIN_TICK)
            this.ticks.unshift({ index: exports.CL_MIN_TICK, DLiquidity: ZERO });
        if (this.ticks[this.ticks.length - 1].index < exports.CL_MAX_TICK)
            this.ticks.push({ index: exports.CL_MAX_TICK, DLiquidity: ZERO });
    }
