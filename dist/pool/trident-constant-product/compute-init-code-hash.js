...
const computeInitCodeHash = ({ creationCode, deployData, masterDeployerAddress, }) => {
    return (0, solidity_1.keccak256)(['bytes'], [
        (0, solidity_1.pack)(['bytes', 'bytes'], [
            creationCode,
            abi_1.defaultAbiCoder.encode(['bytes', 'address'], [deployData, masterDeployerAddress]),
        ]),
    ]);
};
exports.computeInitCodeHash = computeInitCodeHash;
//# sourceMappingURL=compute-init-code-hash.js.map